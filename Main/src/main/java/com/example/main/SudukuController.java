...
//        }
    ...
    private void setValue(){
        ...
        if(qb1[i[3][3]]) {
            int sm = i[3][3];
            if (!qb1[i[4][4]] && !fb2[i[3][3]]) {
                i[3][3] = i[4][4];
                i[4][4] = sm;
            } else if (!qb1[i[5][4]] && !fb3[i[3][3]]) {
                i[3][3] = i[5][4];
                i[5][4] = sm;
            }else if (!qb1[i[4][5]] && !mb2[i[3][3]]) {
                i[3][3] = i[4][5];
                i[4][5] = sm;
            }else if (!qb1[i[5][5]] && !mb3[i[3][3]]) {
                i[3][3] = i[5][5];
                i[5][5] = sm;
            }else if (!qb1[i[3][4]] && !fb1[i[3][3]]) {
                i[3][3] = i[3][4];
                i[3][4] = sm;
            }else if (!qb1[i[3][5]] && !mb1[i[3][3]]) {
                i[3][3] = i[3][5];
                i[3][5] = sm;
            }else if (!qb1[i[4][3]] && !qb2[i[3][3]]) {
                i[3][3] = i[4][3];
                i[4][3] = sm;
            }else if (!qb1[i[5][3]] && !qb3[i[3][3]]) {
                i[3][3] = i[5][3];
                i[5][3] = sm;
            }
            ///////////
            ...
            if (!fb1[i[4][4]] && !fb2[sm]) {
                i[3][4] = i[4][4];
                i[4][4] = sm;
            } else if (!fb1[i[5][4]] && !fb3[sm]) {
                i[3][4] = i[5][4];
                i[5][4] = sm;
            }else if (!fb1[i[4][5]] && !mb2[sm]) {
                i[3][4] = i[4][5];
                i[4][5] = sm;
            }else if (!fb1[i[5][5]] && !mb3[sm]) {
                i[3][4] = i[5][5];
                i[5][5] = sm;
            }else if (!fb1[i[3][3]] && !qb1[sm]) {
                i[3][4] = i[3][3];
                i[3][3] = sm;
            }else if (!fb1[i[3][5]] && !mb1[sm]) {
                i[3][4] = i[3][5];
                i[3][5] = sm;
            }else if (!fb1[i[4][3]] && !qb2[sm]) {
                i[3][4] = i[4][3];
                i[4][3] = sm;
            }else if (!fb1[i[5][3]] && !qb3[sm]) {
                i[3][4] = i[5][3];
                i[5][3] = sm;
            }
        }
