...
//        }
    ...
    private void setValue(){
        ...
        if(qb1[i[3][3]]) { ///////////////////>>     1
            ...
            int sm = i[3][4];
            if(!fb1[i[3][5]] && !mb1[sm]){ // 3
                i[3][4] = i[3][5];
                i[3][5] = sm;
            }else if(!fb1[i[4][3]] && !qb2[sm]){ // 4
                i[3][4] = i[4][3];
                i[4][3] = sm;
            }else if(!fb1[i[4][4]] && !fb2[sm]){ // 5
                i[3][4] = i[4][4];
                i[4][4] = sm;
            }else if(!fb1[i[4][5]] && !mb2[sm]){ // 6
                i[3][4] = i[4][5];
                i[4][5] = sm;
            }else if(!fb1[i[5][3]] && !qb3[sm]){ // 7
                i[3][4] = i[5][3];
                i[5][3] = sm;
            }else if(!fb1[i[5][4]] && !fb3[sm]){ //8
                i[3][4] = i[5][4];
                i[5][4] = sm;
            }else if(!fb1[i[5][5]] && !mb3[sm]){ // 9
                i[3][4] = i[5][5];
                i[5][5] = sm;
            }
        }
